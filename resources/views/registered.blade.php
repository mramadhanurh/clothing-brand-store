...
>
  <head>
    ...
    <title>User Registered | Clothing Brand Store</title>
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">Akun Sudah Terdaftar!</h2>
        <p class="mb-4 mx-2">Admin akan menghubungi Anda jika produk sudah tersedia.</p>
