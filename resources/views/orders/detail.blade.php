...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="py-3 mb-4" style="text-align: right;"><span class="text-muted fw-light">Home /</span> Data Pesanan</h5>
                ...
                <div class="table-responsive text-nowrap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Status</label>
                                <form action="{{ url('update-status/' .$order->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <select id="status" name="status" class="form-select form-control">
                                        <option selected value="" disabled>-- Pilih Status --</option>
                                        <option {{ $order->status == '0' ? 'selected' : '' }} value="0">Proses</option>
                                        <option {{ $order->status == '1' ? 'selected' : '' }} value="1">Selesai</option>
                                    </select>
