                    ...
                    <div class="card-body">
                        <form id="submitForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" id="nama_produk" name="nama_produk" value="{{ $produk->nama_produk }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <select id="id_kategori" name="id_kategori" class="form-select form-control @error('id_kategori') is-invalid @enderror">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" value="{{ $produk->harga }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('qty') is-invalid @enderror" id="qty" name="qty" value="{{ $produk->qty }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <select id="status" name="status" class="form-select form-control @error('status') is-invalid @enderror">
                                    <option selected value="" disabled>-- Pilih Status --</option>
                                    <option value="1" {{ $produk->status == '1' ? 'selected' : '' }}>Ready</option>
                                    <option value="0" {{ $produk->status == '0' ? 'selected' : '' }}>Not Ready</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3">{{ $produk->deskripsi }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="{{ asset('storage/' . $produk->image) }}" width="200" height="auto" alt="Image Produk" style="padding: 20px">
                                    </div>
                                    <div class="col-md-8">
